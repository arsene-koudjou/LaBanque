...
public class VotreBanqueApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
     ...
     Client c1 =	clientRepository.save(new Client("Henry","Hen@ryahoo.fr"));
	 Client c2 =	clientRepository.save(new Client("kevin","kev@gmail.com"));
	 ...
	 operationRepository.save(new Versement(new Date(),2700,cp2));
	 operationRepository.save(new Versement(new Date(),1400,cp2));
	 operationRepository.save(new Versement(new Date(),10300,cp2));
	 operationRepository.save(new Retrait(new Date(),5100,cp2));
